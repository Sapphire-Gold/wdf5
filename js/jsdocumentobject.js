...
document.getElementById('tasktitle').style.padding = 'padding';
...
// document.querySelector("ul li:last-of-type").style.background = 'silver';
// document.querySelector("ul li:nth-of-type(3)").style.background = 'silver';
...
// getul.children[1].innerHTML = `Have to read  <a href="#" id="delete-item1" class="delete-item"><i class="fas fa-home"></i></a>`;
...
// chl = getul.children.childElementCount;
...
// Add Custom Attribute   (qualifiedname,value)
...
// newli.innerText = 'hi';
// newli.innerHTML = `List Item 6 <a href="#" id = "delete-item5" class="delete-item"><i class="fas fa-home"></i></a>`;
...
newlink.innerHTML = `<i class="fas fa-home"></i>`;
// console.log(newlink);
...
// getcardaction.replaceChild(newtitle,oldtitle);  //error
...
function myclick(e){
 ...
 // }
  ...
  const geth2 = document.getElementById('tasktitle');
